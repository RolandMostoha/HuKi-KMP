...
- in the bottom of the WP section add a toolbar with 3 icons "+" to add waypoint, "eye" to show/hide the route, "return"
  to create a roundtrip
- add a section with the route time duration, distance, incline, decline
- add a button to "Save Route"
  n the bottom of the WP section add a toolbar with 3 icons "+" to add waypoint, "eye" to show/hide the route, "return"
  to create a roundtrip
